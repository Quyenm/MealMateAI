...
const PROTECTED_PREFIXES = ['/home', '/scan', '/chat', '/recipe', '/fridge', '/history', '/favorites', '/plan', '/nutrition', '/shopping', '/family', '/community', '/profile', '/onboarding', '/settings', '/upgrade', '/admin']
