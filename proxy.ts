...
const PROTECTED_PREFIXES = ['/home', '/scan', '/recipe', '/fridge', '/history', '/favorites', '/plan', '/nutrition', '/shopping', '/family', '/community', '/kitchen', '/profile', '/onboarding', '/settings', '/upgrade', '/admin']
